...
import { mathQuillExtension } from 'mathquill';


interface MathQuillSettings {
	mySetting: string;
	anotherSetting: boolean;
}

const DEFAULT_SETTINGS: MathQuillSettings = {
	mySetting: 'default',
...
export default class MathQuillPlugin extends Plugin {
	settings: MathQuillSettings;

	async onload() {
		await this.loadSettings();
		this.registerEditorExtension(mathQuillExtension());
